...
const string strMessageMagic = "23Coin Signed Message:\n";
...
static const int64 nTargetTimespan = 23 * 60; // 23Coin: 23 minutes
static const int64 nTargetSpacing = 1 * 23 * 60 * 60; // 23Coin: 23 hours
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal 23Coin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "23Coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x16d24a131aaec5e071c3a054306be8417118cb9b7b155ef3673c2655df8928f0");
    }
	...
	//  nTime=1513906623, nBits=1e0ffff0, nNonce=2085386442, vtx=1)
